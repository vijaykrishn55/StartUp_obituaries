          ...
          <CardHeader>
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h3 className="font-semibold cursor-pointer hover:underline" onClick={() => navigate('/profile')}>
                    {post.author.name}
                  </h3>
          ...
          {post.type === "funding" && (
            <div className="px-6 mb-6">
              <div className="p-4 bg-green-500/10 rounded-lg border border-green-500/20">
                <p className="text-2xl font-bold text-green-600 mb-2">{post.fundingAmount}</p>
                <p className="text-sm text-muted-foreground">
                  {post.fundingStage} • Led by {post.investors}
                </p>
              </div>
            </div>
          )}
                    ...
                    <div className="flex-1">
                      <div className="bg-muted/50 rounded-lg p-4">
                        <div className="flex items-start justify-between mb-2">
                          <div>
                            <h4 className="font-semibold text-sm cursor-pointer hover:underline" onClick={() => navigate('/profile')}>
                              {comment.author.name}
                            </h4>

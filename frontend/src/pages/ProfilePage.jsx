    ...
    <div className="max-w-4xl mx-auto">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          ...
          >
            ...
            <form onSubmit={handleEditProfile} className="space-y-4">
              ...
              {/* Only show work/co-founding options for non-students */}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
          ...
          {/* Startup History - Only show for non-students and non-investors */}
          {profile.user_role !== 'student' && profile.user_role !== 'investor' && (
            <div className="card">
            ...
            <div className="space-y-3">
              ...
              {profile.user_role === 'student' && (
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">{userStats.stories_read || Math.floor(Math.random() * 50) + 10}</span>
                </div>
              )}
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">{profile.user_role === 'student' ? 'Reactions Given' : 'Total Reactions'}</span>
